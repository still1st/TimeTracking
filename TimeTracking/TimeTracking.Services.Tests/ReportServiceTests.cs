...
namespace TimeTracking.Services.Tests
{
    ...
    public class ReportServiceTests
    {
        ...
        public ICollection<TableRecord> GetTableRecords(Table table, Employee employee)
        {
            ...
            records.Add(GetTableRecord(table, employee, 2, null, TableRecordType.WeekendDay));
            ...
            records.Add(GetTableRecord(table, employee, 9, null, TableRecordType.WeekendDay));
            ...
            records.Add(GetTableRecord(table, employee, 16, null, TableRecordType.WeekendDay));
            ...
            records.Add(GetTableRecord(table, employee, 23, null, TableRecordType.WeekendDay));
            ...
            records.Add(GetTableRecord(table, employee, 30, null, TableRecordType.WeekendDay));
